...
public class GroupCard extends Card implements Attack, cardStats,
	...
	public int distanceFromRoot() {
		...
		while ((tempMaster != null)) {
			...
			if (tempMaster.getCardType() == 2) {
				...
				if (tempMaster != null) {
					System.out.println("504a888 tempMaster is "
							+ tempMaster.getCardName());
			...
			if (tempMaster.getCardType() == 1) {
				...
				if (tempMaster != null) {
					System.out.println("504Z tempMaster is "
							+ tempMaster.getCardName());
					this.rootMaster = tempMaster;
				}
	...
	public void swapPowerStructureWithPuppets(GroupCard pup) {
		...
		if ((this.getRootMaster() == pup)) {
			...
			// System.out.println("607a calculate distance from root should be 0: "
			// + this.distanceFromRoot());
	...
	public void printOutTypeOfArrows() {
		...
		System.out.println(this.getCardName()
				+ "has the following arrows and types: ");
		if (top != null) {
	...
	public void printOutAvailableAndOccupiedArrowsWithNumbers() {
		System.out
				.println("314 printOutAvailableAndOccupiedArrows with numbers called ");
 ...
 // make sure we don't add puppet again if it is already in the puppets arraylist
	...
	private void addPuppetWithArrowTwo(GroupCard puppet, int arrowDirection) {
		...
		if (arrowDirection == Top) {
			...
			if ((this.getTopArrow() instanceof OutgoingArrow)
				...
				System.out
						.println("303a Top Outgoing arrow is added with this puppet: "
								+ puppet.getCardName());
				...
				System.out
						.println("303c You can't add a puppet to an Incoming arrow. Or the top arrow does not exists");
			}
			...
			if ((this.getBottomArrow() instanceof OutgoingArrow)
				...
				System.out
						.println("304a Bottom Outgoing arrow is added with this puppet: "
								+ puppet.getCardName());
				...
				System.out
						.println("304c You can't add a puppet to an Incoming arrow. Or the bottom arrow does not exists");
			}
			...
			if ((this.getLeftArrowOut() instanceof OutgoingArrow)
				...
				System.out
						.println("305a Left Outgoing arrow is added with this puppet: "
								+ puppet.getCardName());
				...
				System.out
						.println("305c You can't add a puppet to an Incoming arrow. Or the left arrow does not exists");
			}
			...
			if ((this.getRightArrowOut() instanceof OutgoingArrow)
				...
				System.out
						.println("306a Right Outgoing arrow is added with this puppet: "
								+ puppet.getCardName());
				...
				System.out
						.println("306c You can't add a puppet to an Incoming arrow. Or the right arrow does not exists");
			}
		} else {
	...
	public void displayStats() {
		...
		System.out
				.println("\t Transferrable Power: " + this.getTransferPower());
