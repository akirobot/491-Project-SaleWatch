...
public class Game {
    ...
    public static void gameLoop() {
        ...
        System.out
                .println("Sorry you cannot pass a turn because you have already taken an action.\n"
        ...
        if (players.get(playersTurn).getActionsTaken() == 0
                && players.get(playersTurn).getFreeActionsTaken() == 0) {
        System.out.println("You're passing a turn instead because you have taken zero actions");
        ...
        System.out.println("88888 playersTurn is a " + playersTurn);
        playersTurn--;
        System.out.println("88888 playersTurn is b " + playersTurn);
    ...
    public static void passTurn(int player) {
        ...
        checkUnControlledAreaAtEndOfTurn();
        System.out.println("8885 playersTurn is a " + playersTurn);
        playersTurn--;
        System.out.println("8885 playersTurn is b " + playersTurn);
    ...
    public static void atkToControl(int player) {
        ...
        System.out
                .println("0010aab You don't have any available outgoing arrows for your Illuminati. So you can't attack to control with your Illuminati.");
        ...
        atkToControlUncontrolledAreaWithControlledGroupCard(player);
    ...
    public static void atkToDestroy(int player) {
        ...
        atkToDestroyUncontrolledAreaWithControlledGroupCard(player);
    ...
    private static void atkToDestroyUncontrolledAreaWithIlluminati(int player) {
        ...
        System.out.println("0010bb Attack to Destroy with your Illuminati");
    ...
    private static void atkToDestroyUncontrolledAreaWithControlledGroupCard(int player) {

        System.out.println("0010bb Attack to Destroy with your Group Card");
    ...
    private static void atkToControlUncontrolledAreaWithControlledGroupCard(int player) {
        ...
        System.out
                .println("495 You can't add to an already occupied arrow. Or your Group Card does not have an outgoing arrow of that direction.");
        }
     ...
     */
    /*
     * public static void atkToDestroyOLDMETHOD(int player) {
     * 
     * System.out.println("***ATTACK TO DESTROY MENU***");
     * System.out.println("1. Attack another player's power structure\n" +
     * "2. Attack a Group Card from the Uncontrolled Area\n" +
     * "3. Cancel Attack to Destroy\n"); int highestRange = 3; int lowestRange =
     * 1; int choice = CheckInput.checkIntRange(lowestRange, highestRange);
     * 
     * boolean done = false;
     * 
     * while (!done) { // The user can attack another Player's Card if (choice
     * == 1) { // players.get(player).takeAction(); System.out.println(
     * "0010a atkToDestroy another player is under construction");
     * players.get(player).takeAction(); } else if (choice == 2) {
     * System.out.println(
     * "0010a Attack To Destroy another Group Card from Uncontrolled Area is under construction"
     * ); System.out .println("0010b TEST SAMPLE SCENARIO FOR ATK TO DESTROY");
     * 
     * // The user can attack a Card from the Uncontrolled Group
     * 
     * // while loop until attack to destroy is finished /* while(attackIsDone){
     * ??? well player can only attack at most twice per turn
     * 
     * }
     */
    /*
     ...
     * uncontrolledArea.get(0).displayStats();
     * 
     * int attackerIndex = 0; int defenderIndex = 0;
     * 
     * Card attacker = players.get(0).getIlluminati(); Card defender =
     * uncontrolledArea.get(0);
     * 
     * int atkPower = players.get(0).getIlluminati().getPower(); int defPower =
     * uncontrolledArea.get(0).getPower();
     * 
     * int powerDifference = atkPower - defPower; System.out
     * .println("\n011 Power difference is " + powerDifference);
     * 
     ...
     * playerDiceRoll);
     * 
     * boolean successfulAttack = false; if ((playerDiceRoll <= powerDifference)
     * && playerDiceRoll < 11) {
     * System.out.println("\n015 Successful atk to destroy"); successfulAttack =
     * true; } else if (playerDiceRoll == 11 || playerDiceRoll == 12) {
     * System.out.println("\n016 Failed atk to destroy"); } else {
     * System.out.println("\n017 Failed atk to destroy"); }
     * 
     * if (successfulAttack) { deadPile.add(defender); displayDeadPileCards();
     * uncontrolledArea.remove(defenderIndex); }
     * 
     * displayUncontrolledAreaCards();
     * 
     * // If Card is destroyed, it goes to deadPile
     * players.get(player).takeAction(); } else if (choice == 3) { done = true;
     * } done = true; } // while }
     */
    ...
    public static void initializeGroupsCards() {
        ...
        GroupCard AntiNuclearActivists = new GroupCard("AntiNuclearActivists", groupCardType, 2, 0,
                5, 1, face);
        ...
        GroupCard AntiwarActivists = new GroupCard("Antiwar Activists", groupCardType, 3, 0, 0, 1,
                face);
        ...
        GroupCard ChineseCampaignDonors = new GroupCard("Chinese Campaign Donors", groupCardType,
                3, 0, 2, 3, face);
        ...
        GroupCard CongressionalWives = new GroupCard("Congressional Wives", groupCardType, 1, 0, 4,
                1, face);
        ...
        GroupCard ConvenienceStores = new GroupCard("Conveninece Stores", groupCardType, 1, 0, 4,
                3, face);
        ...
        GroupCard EvilGeniuses = new GroupCard("Evil Geniuses For A Better Tomorrow",
                groupCardType, 0, 2, 6, 3, face);
        ...
        GroupCard FastFoodChains = new GroupCard("Fast Food Chains", groupCardType, 2, 0, 4, 3,
                face);
        ...
        GroupCard FiendishFluoridators = new GroupCard("Fiendish Fluoridators", groupCardType, 3,
                0, 5, 1, face);
        ...
        GroupCard FnordMotorCompany = new GroupCard("Fnord Motor Company", groupCardType, 2, 0, 4,
                2, face);
        ...
        GroupCard FraternalOrders = new GroupCard("Fraternal Orders", groupCardType, 3, 0, 5, 3,
                face);
        ...
        GroupCard GoldfishFanciers = new GroupCard("Goldfish Fanciers", groupCardType, 0, 0, 4, 1,
                face);
        ...
        GroupCard InternationalCommunistConspiracy = new GroupCard(
                "International Communist Conspiracy", groupCardType, 7, 0, 8, 6, face);
        ...
        GroupCard LocalPoliceDepartment = new GroupCard("Local Police Department", groupCardType,
                0, 0, 4, 1, face);
        ...
        GroupCard MultinationalOilCompanies = new GroupCard("Multinational Oil Companies",
                groupCardType, 6, 0, 4, 8, face);
        ...
        GroupCard OrbitalMindControlLasers = new GroupCard("Orbital Mind Control Lasers",
                groupCardType, 4, 2, 5, 0, face);
        ...
        GroupCard ParentTeacher = new GroupCard("Parent/Teacher Agglomeration", groupCardType, 0,
                0, 5, 1, face);
        ...
        GroupCard ProfessionalSports = new GroupCard("Professional Sports", groupCardType, 2, 0, 4,
                3, face);
        ...
        GroupCard RobotSeaMonsters = new GroupCard("Robot Sea Monsters", groupCardType, 0, 0, 6, 2,
                face);
        ...
        GroupCard ScienceFictionFans = new GroupCard("Science Fiction Fans", groupCardType, 0, 0,
                5, 1, face);
        ...
        GroupCard SemiconsciousLiberationArmy = new GroupCard("Semiconscious Liberation Army",
        ...
        GroupCard SocietyForCA = new GroupCard("Society for Creative Anarchism", groupCardType, 0,
                0, 4, 1, face);
        ...
        GroupCard SouthAmericanNazis = new GroupCard("South American Nazis", groupCardType, 4, 0,
                6, 2, face);
        ...
        GroupCard TobaccoLiquorCompanies = new GroupCard("Tobacco & Liquor Companies",
                groupCardType, 4, 0, 3, 3, face);
        ...
        GroupCard TriliberalCommission = new GroupCard("Triliberal Commission", groupCardType, 5,
                0, 6, 3, face);
        ...
        GroupCard TheUnitedNations = new GroupCard("The United Nations", groupCardType, 1, 0, 3, 3,
                face);
